  ...
  return <div className="flex justify-center bg-blue-500 text-white">
    <div>
      <ul className="flex flex-wrap md:py-2 items-center">
        <li>
          <Link className="sm:py-2 py-1 hover:border-b hover:border-white border-b border-transparent duration-300 px-5 w-full inline-block" href={'#'}>Dashboard</Link>
        </li>
        <li>
        ...
        <li>
          <Link className="sm:py-2 py-1 hover:border-b hover:border-white border-b border-transparent duration-300 px-5 w-full inline-block" href={'#'}>Price List</Link>
        </li>
        <li>
