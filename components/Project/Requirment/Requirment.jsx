...
nowUTC.setUTCHours(nowUTC.getUTCHours() + 6);
  ...
  const handleRequirement = (data) => {
    ...
    const localProject = typeof window!== 'undefined' && JSON.parse( window.localStorage.getItem('projectData')) 
  ...
  return (
   <>
   {
    ...
    <Toast />
    <div className={`${router?.pathname==='/message/project/[projectId]' ? "": 'md:w-9/12 flex justify-center' } `}>
            ...
            <div className="text-left px-3 bg-[#F2F9FF] py-4">
              ...
              <div>
                ...
                >
                  ...
                  {industryFile?.length}
                  <p>{loading?'Uploading...':"Attachment"}{industryFile?.length>1?'s':''}</p>
            ...
            <div className="text-left px-3 bg-[#F2F9FF] py-4">
              ...
              <div>
                ...
                >
                  ...
                  <p>Attachment{informationFile?.length>1?'s':''}</p>
    ...
    {/* Stock */}
    {
      router?.pathname==='/message/project/[projectId]' ? '' : <div className="md:w-3/12">
      <StockImageSites />
    </div>
    }
