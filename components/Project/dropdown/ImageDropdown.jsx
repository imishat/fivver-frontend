      ...
      <div className="selected-option flex w-full" onClick={() => setIsOpen(!isOpen)}>
        {selectedOption ? (
          <div className='flex justify-between items-center w-full mr-6'>
            ...
            <img className="w-12 h-12" src={`http://103.49.169.89:30912/api/v1.0/files/download/public/${selectedOption?.featuredImageId ? selectedOption?.featuredImageId : selectedOption?.imageIds[0]}`} alt="" />
          ...
          selectedDesign?.map((option, index) => (
            <div className='flex text-lg text-blue-500 font-bold border py-1 px-1 items-center gap-3' key={index} onClick={() => {
              ...
              setIsOpen(false);
               ...
               <img className="w-12 h-12" src={`http://103.49.169.89:30912/api/v1.0/files/download/public/${option?.featuredImageId ? option?.featuredImageId : option?.imageIds[0]}`} alt="" />
