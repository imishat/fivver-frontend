    ...
    <div className="md:flex gap-3">
      <div className="md:w-2/3">
        <div>
          <div className="flex  flex-col sm:flex-row justify-center sm:justify-between items-center px-6 border border-gray-400 h-16">
            <h2 className="sm:text-2xl font-bold text-[#1881cc] truncate pr-4">
      ...
      <div className="md:w-1/3 space-y-6">
        ...
        <div className="bg-[#F2F9FF] px-2 py-2">
          <div className="px-4 ">
            <h3 className="py-3 border-b text-[#1881cc] border-[#1C8CDC] text-xl font-bold">
              This Month
            </h3>
          </div>
          <div className="px-4">
        ...
        <div className="bg-[#FEF0F0] px-2 py-2">
          <div className="px-4 flex items-center  border-[#1C8CDC] border-b justify-between">
            <h3 className="py-3 text-[#1881cc] text-xl font-bold">All Times</h3>
            {/* Sort */}
            <select
        ...
        <div className="bg-[#F2F9FF] px-2 py-2">
          <div className="px-4 ">
            <h3 className="py-3  text-[#1881cc] border-[#1C8CDC] text-xl font-bold">
              Search Project
            </h3>
          </div>
        ...
        <div className="bg-[#FEF0F0] px-2 py-2">
          <div className="px-4 flex items-center  border-[#1C8CDC] border-b justify-between">
            <h3 className="py-3 text-[#1881cc] text-xl font-bold">
              New Visitors
            </h3>
            {/* Sort */}
            <select
