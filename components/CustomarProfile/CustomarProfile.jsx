  ...
  return (
    <div className="my-8 sm:flex gap-6 justify-center w-full">
      <div className="sm:flex justify-center gap-6">
        <div className="sm:w-[43%] w-full md:w-3/12 ">
          {/* User info */}
          ...
          <div className="sm:w-[67%] md:w-8/12">
            ...
            <div className="w-full my-6 sm:my-0">
              <div className="flex mb-8 justify-around items-center text-xl font-bold">
                <button
                  onClick={() => setToggle("")}
                  className={`flex justify-center ${toggle === "" && "border-black border-b"
                    }`}
                >
                  Active Projects
                </button>
                <button
                  ...
                  className={`flex justify-center ${toggle === "completed" && "border-black border-b"
                    }`}
                >
                  Completed Projects
                </button>
