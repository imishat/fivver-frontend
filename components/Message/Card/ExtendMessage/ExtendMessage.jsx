                ...
                user?.role === 'ADMIN' ?
                  <>
                    {message?.action === 'accepted' ? <div className="w-full flex justify-center px-5 pb-3">
                      <button className="bg-[#1881cc] text-white px-6 rounded-full font-bold py-2">Accepted</button>
                    </div>
                      :
                      ''}
                    ...
                    {message?.action === 'accepted' || message?.action === 'canceled' ? '' :
                      <div className="w-full flex justify-between px-5 pb-3">
                        <button className="w-full bg-[#1881cc] text-white font-bold py-2 " onClick={() => {
                          setId(message?.messageId)
                        }}>Cancel Extend Time</button>
                      </div>
                    }
                  </>
                  :
                  <>
                    ...
                    {message?.action === 'accepted' || message?.action === 'canceled' ? '' :
                      <div className="w-full flex justify-between px-5 pb-3">
                        ...
                        <button onClick={() => handleExtendDate()} className="bg-[#1881cc] text-white px-5 font-bold py-2">Accept</button>
                      </div>
                    }
                  </>
