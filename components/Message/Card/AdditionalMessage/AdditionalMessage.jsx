...
function AdditionalMessage({ message, setReply }) {
      ...
      <div className="flex w-full px-2  gap-2 py-3 relative">
        ...
        <div className="w-9">
          {message?.sender?.profilePicture ? (
            ...
            <div className="bg-rose-100 w-9 h-9 object-cover rounded-full flex justify-center items-center font-bold">
        ...
        <div className="w-full">
          ...
          <div className="relative">
            <p className="my-2">Additional Offer</p>
            {message?.reply?.messageId ? (
              ...
              >
                ...
                <span>
                  {message?.message?.reply?.reply?.length > 55 ? "..." : ""}
                </span>{" "}
              </a>
            ) : (
              ""
            ...
            <div className="max-w-lg bg-blue-50 h-full">
              ...
              <div className="flex bg-blue-200 items-center justify-between p-3">
                {/* days */}
                <h2 className="font-bold w-3/6">Item</h2>
                {/* Offer title */}
              ...
              {/* Offer Body */}
              <div className="my-4 pb-5 px-1 flex  justify-between mx-4 border-b ">
                <p className=" w-3/6 mr-3">{message?.message}</p>
                <p>{message?.days} Days</p>
                <p>${message?.amount}</p>
              </div>
              {/* Offer total */}
              <div className="my-4 pb-5 px-1  mx-4 border-b ">
              ...
              {/* Offer total */}
              <div className="my-4 px-1  mx-4 border-b ">
                <div className="flex items-center justify-between">
                  <p>Total</p>
                  <p>${parseInt(message?.amount)+0}</p>
                </div>
              </div>
              {/* <div>
                ...
                {user?.role === "ADMIN" ? (
                  <>
                    {message?.action === "accepted" ? (
                      <div className="w-full flex justify-center px-5 pb-3">
                        <button className="bg-[#1881cc] text-white px-6 rounded-full font-bold py-2">
                          Accepted
                        </button>
                      </div>
                    ) : (
                    ...
                    {message?.action === "canceled" ? (
                      <div className="w-full flex justify-center px-6 rounded-full pb-3">
                        <button className="bg-gray-400 text-white px-5 font-bold py-2">
                          Canceled
                        </button>
                      </div>
                    ) : (
                    ...
                    message?.action === "canceled" ? (
                      ...
                      <div className="w-full flex justify-between px-5 pb-3">
                        <button
                          className="w-full bg-[#1881cc] text-white font-bold py-2 "
                          onClick={() => {
                    ...
                    message?.action === "canceled" ? (
                      ...
                      <div className="w-full flex justify-between px-5 pb-3">
                        ...
                        <button
                          ...
                          className="bg-[#1881cc] text-white px-5 font-bold py-2"
                        >
                          Accept
                        </button>
                      </div>
            ...
            <p
              id={message?.messageId}
              className={`text-sm bg-base-100  flex items-center gap-2 ${
                message?.reply ? "mt-0" : ""
              }`}
            >
              {/* {message?.message} */}
        ...
        {id?.length ? (
          <div className="w-96 fixed left-[20%] z-50 p-3 top-1/2 rounded-md bg-base-100 border-2 items-center flex justify-center">
            <div className="w-96 h-full">
              <div>
                <h2 className="text-xl font-bold">Additional Offer</h2>
                <p className="my-4">Confirm to cancel Additional Offer</p>
              </div>
