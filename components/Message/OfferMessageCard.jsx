        ...
        <div className="relative">
          {
           ...
           <div className="max-w-md bg-blue-50 h-full">
            ...
            <div className="flex bg-blue-200 items-center justify-between p-3">
                <img className="w-14 object-cover h-14 border p-1 border-gray-400" src={`http://103.49.169.89:30912/api/v1.0/files/download/public/${message?.imageId}`} alt="" />
                {/* Offer title */}
            ...
            <div>
                <p className="p-3">{message?.message}</p>
                    <ul className="mt-6 mx-3">
                        <li className="font-bold flex items-center gap-1"><BsCheckCircleFill className="text-blue-500" /> 2 Day Delivery</li>
                        <li className="font-bold flex items-center gap-1"><BsCheckCircleFill className="text-blue-500" /> Double Sided Design</li>
                    </ul>
            </div>
            {/* Offer Button */}
