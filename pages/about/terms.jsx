          ...
          <div className=" flex justify-center text-left">
            ...
            <div className="pl-20  max-w-7xl w-9/12">
              ...
              <div className='pl-5'>
                ...
                <ul className='relative after:absolute mb-5 after:h-2 after:w-2 after:top-[7px] after:left-[-20px] after:bg-blue-400 after:rounded-full'>
                  <li className='font-dm text-[#444444] font-normal text-base'>No complaints will be accepted after project completion. You cannot cancel the project without any reason.</li>
                </ul>
