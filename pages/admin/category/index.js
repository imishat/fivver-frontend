        ...
        <AdminLayout title={'Category'}>
             <div className="flex justify-center w-full">
                ...
                <form>
                        ...
                        <label className="" htmlFor="title">Price</label>
                        <input className="w-full px-2 input input-bordered py-2" type="number" />
                        <label className="" htmlFor="title">Sub Category IDs</label>
                        <input className="w-full px-2 input input-bordered py-2" type="text " />
                        <label className="" htmlFor="title">Image ID</label>
                        <input className="w-full px-2 input input-bordered py-2" type="text" />
